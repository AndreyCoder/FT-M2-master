...
var btnImpar = document.getElementById('incementoImpar')
btnImpar.onclick = () => store.dispatch(impar())

var btnAsincrono = document.getElementById('incementoAsync')
btnAsincrono.onclick = () => setTimeout(() => store.dispatch(incremento()), 1000)